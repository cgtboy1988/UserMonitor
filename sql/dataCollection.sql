...
--
-- Host: localhost:3306
-- Generation Time: Sep 12, 2017 at 05:41 AM
...
ALTER TABLE `KeyboardInput`
  ADD PRIMARY KEY (`username`,`user`,`pid`,`start`,`xid`,`timeChanged`,`inputTime`,`type`) USING BTREE;
...
ALTER TABLE `MouseInput`
  ADD PRIMARY KEY (`username`,`user`,`pid`,`start`,`xid`,`timeChanged`,`inputTime`) USING BTREE;

--
-- Indexes for table `Process`
--
ALTER TABLE `Process`
  ADD PRIMARY KEY (`username`,`user`,`pid`,`start`) USING BTREE;

--
-- Indexes for table `ProcessArgs`
--
ALTER TABLE `ProcessArgs`
  ADD PRIMARY KEY (`username`,`user`,`pid`,`start`,`numbered`) USING BTREE;

--
-- Indexes for table `ProcessAttributes`
--
ALTER TABLE `ProcessAttributes`
  ADD PRIMARY KEY (`username`,`user`,`pid`,`start`,`timestamp`) USING BTREE;

--
-- Indexes for table `Screenshot`
--
ALTER TABLE `Screenshot`
  ADD PRIMARY KEY (`username`,`taken`) USING BTREE;

--
-- Indexes for table `Task`
--
ALTER TABLE `Task`
  ADD PRIMARY KEY (`username`,`taskName`) USING BTREE;

--
-- Indexes for table `TaskEvent`
--
ALTER TABLE `TaskEvent`
  ADD PRIMARY KEY (`username`,`taskName`,`eventTime`) USING BTREE;
...
--
ALTER TABLE `UserIP`
  ADD PRIMARY KEY (`username`,`ip`,`start`) USING BTREE;

--
-- Indexes for table `Window`
--
ALTER TABLE `Window`
  ADD PRIMARY KEY (`username`,`user`,`pid`,`start`,`xid`) USING BTREE;

--
-- Indexes for table `WindowDetails`
--
ALTER TABLE `WindowDetails`
  ADD PRIMARY KEY (`username`,`user`,`pid`,`start`,`xid`,`timeChanged`) USING BTREE;
